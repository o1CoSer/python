...
print("Resultado de True AND False:",True and True)
print("Resultado de True AND False:",True and False)
print("Resultado de False AND True:",False and True)
print("Resultado de False AND True:",False and False)
print("Resultado de True OR False:",True or True)
print("Resultado de True OR False:",True or False)
print("Resultado de False OR True:",False and True)
print("Resultado de False OR True:",False and False)
...
numero2=float(input("Segundo nuemro:"))
